...
**This project's Server/Client boundary rule, trigger table, and the module-graph/children-composition patterns live in [`client/docs/ui-architecture.md`](../../../../client/docs/ui-architecture.md) — read that file, not this one, for the boundary decision itself.** This skill covers the *rest* of the App Router surface (data fetching, Server Actions, route groups, parallel routes) that doc doesn't.
